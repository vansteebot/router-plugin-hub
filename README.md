...
| 安装包文件名 | `ssrp_aarch64_cortex-a53-190_r126_enhanced_full_20260514.run` |
| 本仓库构建路径 | `packages/ssrplus-enhanced/release/ssrp_aarch64_cortex-a53-190_r126_enhanced_full_20260514/ssrp_aarch64_cortex-a53-190_r126_enhanced_full_20260514.run` |
| 校验 | 同目录 `SHA256SUMS.txt`（与发布说明一致） |
| 下载 | [Release 页面](https://github.com/vansteebot/router-plugin-hub/releases/tag/ssrplus-enhanced-20260514) · [直链 `.run`](https://github.com/vansteebot/router-plugin-hub/releases/download/ssrplus-enhanced-20260514/ssrp_aarch64_cortex-a53-190_r126_enhanced_full_20260514.run) · [全部 Releases](https://github.com/vansteebot/router-plugin-hub/releases) |
...
完整更新说明：[docs/releases/ssrplus-enhanced-20260514.md](docs/releases/ssrplus-enhanced-20260514.md)
